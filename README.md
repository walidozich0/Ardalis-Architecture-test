...
To update the database use this command from the Web project folder (replace `ca_ardalis_explore` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../ca_ardalis_explore.Infrastructure/ca_ardalis_explore.Infrastructure.csproj -s ca_ardalis_explore.Web.csproj
```
